...
async function buildRecommendationsResponse(siteId: string, organizationId: string) {
...
export async function GET(request: Request) {
  try {
    ...
    return await buildRecommendationsResponse(siteId, actorResult.actor.organizationId);
  } catch (error) {
...
export async function POST(request: Request) {
  try {
    ...
    return await buildRecommendationsResponse(parsedSiteId.siteId, actorResult.actor.organizationId);
  } catch (error) {
    return mapRouteError(error);
  }
}
