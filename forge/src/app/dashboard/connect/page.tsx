    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ margin: 0, fontSize: 14, color: MUTED, lineHeight: 1.65, maxWidth: 460 }}>
          Start with your URL. Forge will begin learning your funnel immediately —
        ...
        <Card>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            <div>
              ...
              <p style={{ margin: "3px 0 0", fontSize: 12, color: MUTED }}>Required — the canonical domain Forge will analyze.</p>
            </div>
        ...
        <Card style={{ opacity: siteConnected ? 1 : 0.5 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            <div>
              ...
              <p style={{ margin: "3px 0 0", fontSize: 12, color: MUTED }}>
                Connects Forge to your PostHog project for event sync and insights.
              </p>
            </div>
        ...
        <Card style={{ opacity: siteConnected ? 1 : 0.5 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            <div>
              ...
              <p style={{ margin: "3px 0 0", fontSize: 12, color: MUTED }}>
                Route Segment events to Forge via webhook for additional signal.
              </p>
            </div>
