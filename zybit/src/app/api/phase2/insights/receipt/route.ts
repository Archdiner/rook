...
import type { ZybitReceiptV1Envelope } from '@/lib/phase2/types';
...
/**
 * Credibility exports: **`zybit.receipt.v1`** JSON or downloadable Markdown companion.
 *
...
export async function POST(request: Request) {
  try {
    ...
    if (format === 'markdown') {
      ...
      const name = `zybit-receipt_${filenameSafe(siteId)}_${stamp || 'export'}.md`;
    ...
    const envelope: ZybitReceiptV1Envelope = {
